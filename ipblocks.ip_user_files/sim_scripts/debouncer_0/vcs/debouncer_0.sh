...
compile()
{
  vlogan -work work $vlogan_opts -sverilog \
...
elaborate()
{
  vcs $vcs_elab_opts work.debouncer_0 work.glbl -o debouncer_0_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key debouncer_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc debouncer_0_simv.daidir vcs_lib c.obj)
