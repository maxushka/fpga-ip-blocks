...
#
# Script generated by Vivado on Thu May 22 11:00:22 +0300 2025
...
#
# Usage        : debouncer_0.sh
#                debouncer_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                debouncer_0.sh [-reset_run]
#                debouncer_0.sh [-reset_log]
#                debouncer_0.sh [-help]
#
...
#                script (type 'debouncer_0.sh -help' for more information).
#
...
design_libs_elab="-libname work -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver work)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "debouncer_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./debouncer_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work work $xmvlog_opts -sv \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab work.debouncer_0 work.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts work.debouncer_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log debouncer_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: debouncer_0.sh [-step]\n\
Usage: debouncer_0.sh [-lib_map_path]\n\
Usage: debouncer_0.sh [-reset_run]\n\
Usage: debouncer_0.sh [-reset_log]\n\
Usage: debouncer_0.sh [-keep_index]\n\
