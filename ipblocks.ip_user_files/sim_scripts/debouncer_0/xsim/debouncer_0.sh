...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L work -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot debouncer_0 work.debouncer_0 work.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb debouncer_0.wdb xsim.dir libdpi.so)
